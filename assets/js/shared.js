...
function renderSidebar() {
  ...
  const nav = [
    ...
    { href: '#', icon: logoutIcon(), label: 'Logout', section: 'system', logout: true },
  ];
    ...
    <aside class="sidebar">
      ...
      <div class="sidebar-admin">
        ...
        <div class="admin-info">
          <span class="admin-name">Dr. Sarah Admin</span>
...
function initPage(title, subtitle) {
  document.body.insertAdjacentHTML('afterbegin', renderSidebar() + `<div class="main-wrapper">${renderTopbar(title, subtitle)}<div class="page-content" id="pageContent"></div></div>`);
}
